...
+ [Interactief Op frajaweb (log in met github-account)](https://jupyterhub.frajaweb.com/hub/login), of [in deze git in 'ipynb'-formaat](https://github.com/ParadigmaFunctioneel/functioneelElm/tree/master/notebooks), of [leesbaar in deze git (maar links werken nog niet allemaal)](notebooks/Welcome).
