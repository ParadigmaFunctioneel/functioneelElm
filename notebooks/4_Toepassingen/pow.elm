...
var author$project$Main$checkedStringToFloat = function (s) {
	return A2(
...
var author$project$Main$listStringToListFloat = function (ls) {
	return A2(elm$core$List$map, author$project$Main$checkedStringToFloat, ls);
};
var elm$core$Basics$mul = _Basics_mul;
var elm$core$Basics$sub = _Basics_sub;
var author$project$Main$pow = F2(
	function (g, m) {
		if (!m) {
			return 1;
		} else {
			return g * A2(author$project$Main$pow, g, m - 1);
		}
	});
...
var author$project$Main$powTest = function (s) {
	var lf = author$project$Main$listStringToListFloat(
	...
	var m = A2(
		...
		elm$core$List$head(
			A2(
				elm$core$Maybe$withDefault,
				_List_Nil,
				elm$core$List$tail(lf))));
	var g = A2(
		elm$core$Maybe$withDefault,
		0,
		elm$core$List$head(lf));
	return elm$core$String$fromFloat(
		A2(
			author$project$Main$pow,
			g,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$placeholder('numbers separated by ,'),
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$Main$powTest(model.content))
					]))
			]));
};
